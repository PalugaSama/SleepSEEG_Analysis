function [SleepStage]=SleepSEEG(FileList,ExtraFiles)
 ...
 %
 % Version changes: fixed bug when reaing EDF file.
 % SleepSEEG v2.0
 % Nicolás von Ellenrieder - 2022-12-07
...
for nf=1:length(file)
    ...
    %StartTime=[header_ini(99:109) ' ' header_ini(177:178) ':'
    %header_ini(180:181) ':' header_ini(183:184)];---- Modifié pour pouvoir
    %lire correctement 
    StartTime=[header_ini(169:170) '-' header_ini(172:173) '-20' header_ini(175:176) ' ' header_ini(177:178) ':' header_ini(180:181) ':' header_ini(183:184)];
    disp(StartTime)
